...
description: 'How we configure the D-Sports docs site using docs.json: theme, colors, logo, navigation.'
icon: 'gear'
---

The D-Sports docs site at [docs.d-sports.org](https://docs.d-sports.org) is driven by a single `docs.json` file in this repo. It controls the site name, logo, colors, navigation, footer, and more. Below are the main properties we use and their meanings for this project.

## Properties

<ResponseField name="name" type="string" required>
Name of the site. Used for the global title (e.g. in the browser tab and header).

Example: `D-Sports Docs`
...
<ResponseField name="navigation" type="Navigation[]" required>
  ...
  <Expandable title="Navigation">
    ...
    The relative paths to the MDX files (no extension).

    Example: `["index", "quickstart", "repositories/ecosystem-overview"]`
...
<ResponseField name="topbarLinks" type="TopbarLink[]">
  ...
  <Expandable title="TopbarLink">
    ...
    The url once you click on the button. Example: `https://docs.d-sports.org`
    </ResponseField>
...
<ResponseField name="api" type="API">
  Configuration for API settings. Learn more about API pages at [API Components](https://mintlify.com/docs/api-playground/).
    ...
    <ResponseField name="playground" type="Playground">
      ...
      <Expandable title="Playground">
        <ResponseField name="mode" default="show" type='"show" | "simple" | "hide"'>
          ...
          Learn more at the [playground guides](https://mintlify.com/docs/api-playground/)
        </ResponseField>
      </Expandable>
    </ResponseField>
...
<ResponseField name="footerSocials" type="FooterSocials">
  ...
  <Expandable title="FooterSocials">
    ...
    Example: `https://x.com/dsportsorg`
    </ResponseField>
  </Expandable>
</ResponseField>
