...
New daily mini-games (Pick'em, Trivia, air hockey, locker-singularity, and later registrations) use the [Game Engine](/api-reference/domains/game-engine). Do not treat `/api/v1/engage/games/*` as a replacement for this catalog. Locker Singularity progress lives on `/api/v1/engage/games/locker-singularity/ledger`, not on the session verbs.
