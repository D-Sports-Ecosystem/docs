...
| `/api/events/*` | Publish | Game Center schedule, detail, stats, plays, lineup, chat, mute, presence, ratings. |
...
Current intentional gaps in generated OpenAPI are admin/debug/internal operations plus marketplace catch-all, KYC, and remaining live/pick-em play routes. Curated domain pages cover approved admin/team routes and those pending public contracts without exposing sensitive internals.
