...
| `/api/user/check-username` | Shipped, OpenAPI pending | Public handle availability check. |
...
| `/api/accessibility` | Shipped, OpenAPI pending | Public Apple Nutrition Label support matrix for native and marketing. |
| `/api/notifications*` (non-admin) | Shipped, OpenAPI pending | Authenticated inbox, read, read-all, archive. |
