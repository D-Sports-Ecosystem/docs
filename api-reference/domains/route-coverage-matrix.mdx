...
| `/api/binders*` | Publish | Digital binder CRUD, card assign/order, transfer, and PIN. |
| `/v1/marketplace/*` | Shipped, OpenAPI pending | Marketplace catch-all. Native `app/market` consumes it. |
