...
- The community directory is `GET /api/user/all` (onboarded users, excluding you, `limit` 1–100). Suggested fans should prefer `GET /api/discovery/fans` and use `/api/user/all` as the fallback list.
