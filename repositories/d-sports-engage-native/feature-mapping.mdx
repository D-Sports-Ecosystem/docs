...
- **Top Fans** leaderboard displays real `points`, `level`, `fans` (follower count), and `rank` from the API. Badge labels are computed from point thresholds via `getFanBadgeLabel`.
- Web carousels for Top Fans and Top Teams support mouse-drag scrolling and dot-based page navigation.
