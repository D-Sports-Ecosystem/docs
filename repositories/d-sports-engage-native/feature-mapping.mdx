...
- The collectibles view has two sub-tabs: **My Cards** (owned collectibles only) and **My Packs** (unopened and opened packs). Opened packs no longer appear in **My Cards**.
