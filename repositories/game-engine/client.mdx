...
Native 1.25.1 registers Pick'em, Trivia, prize-wheel, guess-the-player, daily lineup, card trivia, login-streak scratcher, and the six hockey playfields in `lib/games/register-shipped.ts`.
