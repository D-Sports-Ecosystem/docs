...
Daily Spin and Guess the Player still use dedicated modal routes. They are not engine games yet.
...
v1 ships `lib/games/pickem` (`daily-pickem`) and `lib/games/trivia` (`daily-trivia`).
