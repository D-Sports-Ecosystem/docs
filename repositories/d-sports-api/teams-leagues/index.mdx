...
- Public reads: `/api/teams`, `/api/teams?slug=`, `/api/teams/search`, `/api/leagues`, `/api/config/sports`
...
Search, join, user-teams, and the sports catalog are shipped. They are not in the generated OpenAPI yet.
