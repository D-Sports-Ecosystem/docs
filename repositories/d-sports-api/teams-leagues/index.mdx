...
- Public reads: `/api/teams`, `/api/teams?slug=`, `/api/teams/search`, `/api/teams/{id}/roster`, `/api/leagues`, `/api/leagues/{leagueId}/standings`, `/api/config/sports`
...
Search, join, roster, user-teams, leagues, and the sports catalog are in the generated OpenAPI.
