...
- Public reads: `/api/teams`, `/api/teams?slug=`, `/api/teams/search`, `/api/teams/{id}/roster`, `/api/teams/{id}/head-to-head?opponentId=`, `/api/teams/{id}/achievements`, `/api/leagues`, `/api/leagues/{leagueId}/standings`, `/api/config/sports`
...
Search, join, roster, head-to-head, user-teams, leagues, standings, and the sports catalog are in the generated OpenAPI.
