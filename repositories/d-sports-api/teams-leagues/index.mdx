...
- Public reads: `/api/teams`, `/api/teams?slug=`, `/api/teams/search`, `/api/teams/{id}/roster`, `/api/teams/{id}/head-to-head`, `/api/leagues`, `/api/leagues/{leagueId}/standings`, `/api/config/sports`
