...
- Commenting on a post sends a `SOCIAL_COMMENT` notification to the post author. Mentions in posts trigger a `SOCIAL_MENTION` notification, and new follows trigger a `SOCIAL_FOLLOW` notification.
