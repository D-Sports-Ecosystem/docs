...
- `POST /api/v1/engage/quests/{questId}/session`: start a timed daily-quest quiz session.
- `POST /api/v1/engage/quests/session/{sessionId}/submit`: submit an answer.
- `POST /api/v1/engage/quests/session/{sessionId}/forfeit`: burn the UTC-day attempt.
- `GET /api/v1/engage/quests/daily-summary`: per-followed-team checklist.
- `POST /api/v1/engage/quests/arena-check-in`: once per team per UTC day.
