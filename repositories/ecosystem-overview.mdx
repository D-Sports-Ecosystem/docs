...
- Use the [Game Engine](/repositories/game-engine/index) (`/api/v1/engage/games/*`) for daily mini-games. Native 1.25.9 registers Pick'em, Trivia, prize-wheel, guess-the-player, lineup, card trivia, streak scratcher, six hockey playfields, air hockey, and locker-singularity. The API owns sessions and awards. Locker Singularity uses the idle ledger. Keep calling legacy `/api/games/*` play routes and Game Center.
