...
- Use the [Game Engine](/repositories/game-engine/index) (`/api/v1/engage/games/*`) for daily mini-games. Native 1.25.1 registers Pick'em, Trivia, prize-wheel, guess-the-player, lineup, card trivia, streak scratcher, and six hockey playfields. The API owns sessions and awards. Keep calling legacy `/api/games/*` play routes and Game Center.
