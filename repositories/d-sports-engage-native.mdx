...
- In-app legal documents (Terms of Service, Privacy Policy, EULA) are now rendered in a structured card layout via `TextContentModal` and kept in sync with the `d-sports-site` website pages.
