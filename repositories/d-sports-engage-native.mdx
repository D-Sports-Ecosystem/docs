...
- **EULA, Terms of Service, and Privacy Policy are now rendered in-app** via a structured modal under **Settings > Legal**. Each document is parsed into titled sections with proper formatting. EULA acceptance is tracked per version.
