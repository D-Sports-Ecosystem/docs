...
- UGC safeguards added: report/block moderation UX, mandatory EULA/terms gating before posting or commenting, and toast-based feedback for all moderation actions.
...
- **Pack opening odds** — Native odds disclosure behavior is documented with policy-aligned copy and evidence requirements. Disclosure values must come from backend payloads and remain visible/accessible near open actions.
- **UGC safeguards** — Report and block moderation controls are available on all locker room posts and comments. Mandatory terms acceptance is required before posting or commenting, satisfying Apple guideline 1.2 and Google Play UGC policy.
