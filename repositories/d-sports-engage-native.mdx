...
- Profile badge rendering now consumes server-provided `badgeMetadata` and `levelBadge` as the primary achievement source, with legacy string-based mapping retained as fallback.
