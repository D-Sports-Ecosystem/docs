...
- **Profile** — User profile, milestone avatar rings, and settings
- **Theme** — Dark/light mode (default dark)

## What changed since last docs sync

- Profile avatars now display milestone-tier gradient rings based on the user's claimed rewards count, with four tiers (Starter, Momentum, Elite, Legend) and animated effects for higher tiers.
