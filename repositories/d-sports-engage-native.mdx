...
- **Wallet** — Token balances, holdings, pack opening, send/receive actions, and crypto checkout (via PWA backend)
...
2. Copy `.env.example` to `.env` and configure the required environment variables (see below).
