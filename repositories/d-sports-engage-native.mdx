...
The wallet includes a **View Security** option that lets you reveal your secret recovery phrase or seed phrase. When you tap **View Security** from the wallet screen, you are guided through a multi-step flow:

1. **Select** — Choose whether to reveal your **recovery phrase** or **seed phrase**.
2. **Warning** — Review a security warning reminding you never to share your phrase.
3. **Environment check** — Confirm you are in a safe environment.
4. **PIN verification** — Enter your PIN to authorize the reveal.
5. **Reveal** — Your phrase is displayed on screen.

<Warning>
  Never share your seed phrase or recovery phrase with anyone. Anyone who has it
  can permanently steal your funds. D-Sports will never ask for it.
</Warning>
