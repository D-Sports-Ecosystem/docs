...
- **Client-side UGC hiding** — after reporting a post, comment, or profile you are prompted to hide it from your feed. Hidden state is stored locally via MMKV and applied instantly.
