...
- **Settings** — Reorganized into dedicated sub-pages: data usage, legal (privacy policy, terms of service, EULA), notifications, and app info
...
- Settings page was reorganized: legal content (privacy policy, terms of service, EULA) now lives on a dedicated `/settings/legal` page, and an "App Info" section was added to the main settings screen.
