...
- OpenAPI is **187** paths. New generated surfaces include `/api/v1/marketplace/*`, KYC (`/api/v1/kyc/*`, `/api/v1/user/kyc-status`), the [Game Engine](/repositories/game-engine/index), leftover public `/api/games/*` play routes, `GET /api/events/realtime`, and `GET /api/leagues/{leagueId}/standings`.
