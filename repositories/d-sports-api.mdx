...
- OpenAPI is 132 paths. New generated surfaces include sports catalog, team search/join/roster, leagues, locker-room drafts/likes, Game Center `/api/events/*`, notifications, and settings.
