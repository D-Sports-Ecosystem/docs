...
- OpenAPI is **150** paths. New generated surfaces include the [Game Engine](/repositories/game-engine/index) (`/api/v1/engage/games/*`), leftover public `/api/games/*` play routes, `GET /api/events/realtime`, and `GET /api/leagues/{leagueId}/standings`.
